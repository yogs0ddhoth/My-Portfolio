...
export default function ({ matchDownXs, matchDownSm }: { matchDownXs: Boolean, matchDownSm: boolean }) {
  return (
    <Page
      header={{
        title: <Typography variant={matchDownXs? 'h3' : "h1"}>Resume</Typography>,
      ...
      actions={
        <Link underline='none' href={benLinResume} download>
          <Button sx={{textDecoration: 'none'}} variant="outlined" size="large">
            Download
          </Button>
        </Link>
      }
